 ...
 * decks. Same navigation: scroll-snap, prev/next, jump dots, keys,
 * wheel-to-horizontal.
 */
...
export function AboutDeck({ token }: { token: string }) {
  ...
  const cls = 'flex h-full min-h-full w-full min-w-full flex-none snap-start items-start justify-center overflow-y-auto px-6 py-6';
  ...
  return (
    <div className="relative flex h-[calc(100vh-3.5rem)] flex-col">
      ...
      <div ref={containerRef} className="about-deck-scroll flex flex-1 snap-x snap-mandatory overflow-x-auto overflow-y-hidden scroll-smooth">
        {/* 0 — Overview */}
        <section data-idx={0} ref={setRef(0)} className={cls}>
        ...
        {/* 1 — The problem */}
        <section data-idx={1} ref={setRef(1)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
        ...
        {/* 2 — Where it fits */}
        <section data-idx={2} ref={setRef(2)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
        ...
        {/* 3 — Two bookends */}
        <section data-idx={3} ref={setRef(3)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
        ...
        {/* 4 — How it works */}
        <section data-idx={4} ref={setRef(4)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
            <Hero Icon={Workflow} label="How it works" accent="#0ea5e9" title="Connect, synthesise, act" />
        ...
        {/* 5 — Earned value */}
        <section data-idx={5} ref={setRef(5)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
        ...
        {/* 6 — What it is / isn't */}
        <section data-idx={6} ref={setRef(6)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
            <Hero Icon={Scale} label="Boundaries" accent="#64748b" title="What it is — and isn’t" />
        ...
        {/* 7 — Differentiator */}
        <section data-idx={7} ref={setRef(7)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
        ...
        {/* 8 — The agents */}
        <section data-idx={8} ref={setRef(8)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
        ...
        {/* 9 — Capabilities */}
        <section data-idx={9} ref={setRef(9)} className={cls}>
          <div className="mx-auto w-full max-w-4xl">
