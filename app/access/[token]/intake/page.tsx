...
export default async function IntakeLanding({ params }: { params: Promise<{ token: string }> }) {
              ...
              <div className="mt-3 space-y-2">
                {drafts.map((d) => {
                  ...
                  return (
                    <Link
                      key={d.id}
                      href={`/access/${token}/intake/${d.segment}?draft=${d.id}`}
