...
export default async function ChangesAnalyticsPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  return (
    <div className="container mx-auto max-w-screen-xl px-8 py-6 space-y-4">
      <section>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Change orders across the portfolio — commercial exposure and margin impact.</p>
      </section>
